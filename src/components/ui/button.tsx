...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default: 
          "bg-white text-black shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(124,58,237,0.4)] hover:bg-primary hover:text-white hover:border-primary/50 border border-transparent hover:-translate-y-0.5",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-lg",
        outline:
          "border border-white/10 bg-transparent hover:bg-primary/10 hover:border-primary/50 hover:text-primary hover:shadow-[0_0_15px_rgba(124,58,237,0.1)] backdrop-blur-sm",
        secondary:
