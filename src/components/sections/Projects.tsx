...
const projects = [
  ...
  {
    title: "E-Commerce V2",
    description: "Headless Shopify storefront with extreme performance.",
    tags: ["Shopify", "Remix", "Hydrogen"],
  ...
  },
  {
    ...
    tags: ["Storybook", "Radix UI", "Turborepo"],
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 lg:gap-6">
          {projects.map((project, index) => (
            <motion.div
              ...
              className={cn(
                "group relative overflow-hidden rounded-3xl bg-neutral-900/50 border border-white/5 hover:border-white/10 transition-all duration-500 hover:shadow-2xl hover:shadow-black/50",
                project.className
              )}
            >
